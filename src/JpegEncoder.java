...
// the JFIF header
        ...
        JFIF[7] = (byte) 0x46;
        JFIF[8] = (byte) 0x00;
        JFIF[9] = (byte) 0x01; // JFIF File format version
        JFIF[10] = (byte) 0x00;// ''
        JFIF[11] = (byte) 0x01;// units    1=dpi 2=dpcm
        JFIF[12] = (byte) 0x00;// hi H density
        JFIF[13] = (byte) 0x90;// lo H density 90H = 144dpi 48=72dpi
        JFIF[14] = (byte) 0x00;// hi V density
        JFIF[15] = (byte) 0x90;// lo V density
        JFIF[16] = (byte) 0x00;
        JFIF[17] = (byte) 0x00;
        WriteArray(JFIF, out);
